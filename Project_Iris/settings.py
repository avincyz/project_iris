...
SECRET_KEY = 'django-insecure-mm96%g704xov!u_=z1kca+a@+b%x8%odf&-k(khdw3=6kdt_6*'
...
ROOT_URLCONF = 'Project_Iris.urls'
...
WSGI_APPLICATION = 'Project_Iris.wsgi.application'
