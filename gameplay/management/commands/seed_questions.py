...
from gameplay.models import Playbook, GeneratedQuestion, Option
        ...
        for fp in json_files:
            ...
            with transaction.atomic():
                ...
                for q in payload["questions"]:
                    q_obj, created_q = GeneratedQuestion.objects.update_or_create(
